  ...
  return (
    <>
      <section id="sidebar" class="flex sticky bg-white top-20 w-fit h-fit">
        <aside class="flex sticky bg-white" aria-label="Sidebar">
          <div class="overflow-y-auto py-4 px-3 bg-gray-50 rounded dark:bg-gray-800 min-h-max">
            <h1 class="text-center text-red-netflix font-bold text-xl p-2">
              MENU
            </h1>
            <ul class="space-y-2">
              <li>
            ...
            <div className="relative  my-6 mx-auto w-5/12">
              ...
              <div className="border-0  shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
                ...
                <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                  <h3 className="text-3xl font-semibold">RESGISTER ADMIN</h3>
                  <button
                ...
                <form action="" onSubmit={handleSubmit}>
                  <div className="relative p-6 flex-auto">
                    <p className="font-semibold py-5">Register tobe admin</p>
