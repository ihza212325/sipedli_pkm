const CardJob = () => {
  return (
    <>
      <div class="p-4 w-96 bg-white rounded-lg border border-gray-200 shadow-md dark:bg-gray-800 dark:border-gray-700">
        {/* heading Card */}
        ...
        <div className="flex flex-row justify-start">
          ...
          <button
            type="button"
            class="text-whitefont-medium rounded-full text-sm px-3 py-1.5 text-center mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800 flex flex-row gap-2 justify-center items-center"
          >
            <svg
              class="w-4 h-4"
              fill="currentColor"
