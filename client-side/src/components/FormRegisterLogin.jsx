...
const FormRegisterLogin = ({ setShowModal, formType }) => {
  ...
  const handleSubmit = (e) => {
    ...
    dispatch(RegisterAdmin(formLogin)).then((data) => {
      console.log(data);
      if (data === "error") {
        setShowModal(true);
      } else {
          ...
          <div className="relative  my-6 mx-auto w-full md:w-5/12">
            ...
            <div className="border-0  shadow-lg relative flex flex-col w-full bg-white outline-none focus:outline-none">
              ...
              <div className="flex items-start justify-between p-5 border-b border-solid border-slate-200 rounded-t">
                <h3 className="text-3xl font-semibold">RESGISTER NEW USER</h3>
                <button
              ...
              <form action="" onSubmit={handleSubmit}>
                <div className="relative p-6 flex-auto">
                  <p className="font-semibold py-5">Register tobe user</p>
