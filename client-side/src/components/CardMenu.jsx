const CardMenu = ({ name, image, width }) => {
  return (
    <>
      <div className="w-64 rounded my-3 bg-white shadow-lg flex flex-col  text-center">
        <div className="p-7 justify-center justify-items-center">
          {/* <svg
          ...
          <img
            src={image}
            className={`w-${width} h-${width} justify-center justify-items-center`}
            alt=""
          />
